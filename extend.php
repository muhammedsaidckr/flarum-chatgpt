...
//        ->listen(Saving::class, SavingPost::class),
    ...
    (new Extend\Settings())
        ...
        ->default('muhammedsaidckr-chatgpt.cached_models', '[]')
         ->default('muhammedsaidckr-chatgpt.cached_model_metadata', '{}')
         ->default('muhammedsaidckr-chatgpt.models_last_fetched', 0)
         ->default('muhammedsaidckr-chatgpt.auto_recommended_model', '')
         ->default('muhammedsaidckr-chatgpt.last_applied_preset_model', '')
         ->default('muhammedsaidckr-chatgpt.pricing_version', 'openai-2026-04')
